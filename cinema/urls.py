...
from cinema.views import MoviesDetailView, MoviesListView, MovieSessionDetailView, CinemaListView
...
urlpatterns = [
    ...
    path("cinemahalls", CinemaListView.as_view(), name="cinema_hall_list_view")
